...
plot(x,y)
lines(x,ypred)
#para que dibuje la recta de regresión
# capacidad predictiva de la recta, ver como de bien se aproxima a los puntos
# no hay diferencia entre observaciones y lo predicho si es una recta lo qeu predigo
# no puedo predecir nada cuando puedo tirar cualquier linea casi, a la que añado un punto linea cambia mucho
# quiero una medida r^2
# en situacion perfecta r^2 es 1 y en la peor de todas r^2 es 0